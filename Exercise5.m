function Exercise5(varargin)

% Exercise5
%
% Solution of CP model with zero steady state CB credit but allowing it to
% become positive. Interest rate follows Taylor rule.
%
...
% .........................................................................
%
% Created: September 8, 2009 by Vasco Curdia
% Updated: April 21, 2014 by Vasco Curdia
%
% Copyright 2009-2014 by Vasco Curdia
...
%% Exercise type
ExerciseName = ['Exercise5_dSP_',int2str(dSP),'_Pers_',num2str(PersSP)];
isBind = (BindBp~=0);
if isBind
...
zz = {z{:},FLM{:},'Rb','RBaa','RT10y','LongSP','RdLevel','Rrd',...
    'cb','cs','w','wb','ws','Omega',...
    'gammacb','gammacbLevel','lTot','lCB','lPriv',...
