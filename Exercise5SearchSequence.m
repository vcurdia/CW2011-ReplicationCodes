function Exercise5SearchSequence(varargin)

% Exercise5SearchSequence
%
% Searches for optimal sequence in Exercise 5.
%
...
%% Load data
load(['Output_Exercise5',FileNameSuffix])

if strcmp(FileNameSuffix,'_dSP_12_Pers_90_Bind_10bp')
    TZLB.hchitil.NoCP = 2;
    TZLB.hchitil.OptCP = 3;
    nCP1.hchitil.OptCP = 5;
else
    TZLB.hchitil.NoCP = 0;
...
if strcmp(FileNameSuffix,'_dSP_4_Pers_90')
    nCP1.hXitil.OptCP = 43;
elseif strcmp(FileNameSuffix,'_dSP_12_Pers_90_Bind_10bp')
    nCP1.hXitil.OptCP = 18;
else
    nCP1.hXitil.OptCP = 0;
end
...
if strcmp(FileNameSuffix,'_dSP_12_Pers_90_Bind_10bp')
    TZLB.hchitiladd.NoCP = 2;
    TZLB.hchitiladd.OptCP = 2;
    nCP1.hchitiladd.OptCP = 3;
else
...
for jS=1:ncsi,Sj = csi{jS};
    ...
    if ~isFoundSequence
        fprintf('WARNING: Did not find sequence for NoCP!\n')
    end
